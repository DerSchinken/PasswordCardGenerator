...
parser = argparse.ArgumentParser(description="Generate a Password Card. Spaces will automatically be replaced with dots (.)")
...
parser.add_argument("-p", "--png", action="store_true", help="Saves the Password Card as a JPG")
